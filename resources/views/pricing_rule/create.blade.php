...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="row well well-sm">
        {!! Form::open(array('route' => 'pricing_rule.store','name' => 'register_form','class' => 'form-horizontal', 'method' => 'post','files'=>true)) !!}
		<div class="form-group">
			{!! Form::label('name', 'Name', array('class'=>'col-sm-3 control-label')) !!}
			<div class="col-sm-7">
				{!! Form::text('name', old('name'), array('class'=>"form-control",'placeholder'=>"e.g. 3 for 2 deal")) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('customer_code', 'Customer Code', array('class'=>'col-sm-3 control-label')) !!}
			<div class="col-sm-7">
				{!! Form::select('customer_code',$customers, old('customer_code'), array('class'=>"form-control",'placeholder'=>"Select One")) !!}
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				{!! Form::select('operator', array('=','>=') ,old('operator','='), array('class'=>"form-control",'placeholder'=>"Please Select")) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('quantity', 'Quantity', array('class'=>'col-sm-3 control-label')) !!}
			<div class="col-sm-7">
				{!! Form::text('quantity', old('quantity'), array('class'=>"form-control",'placeholder'=>"e.g. 3")) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('special_price', 'Special Price', array('class'=>'col-sm-3 control-label')) !!}
			<div class="col-sm-7">
				{!! Form::text('special_price', old('special_price'), array('class'=>"form-control",'placeholder'=>"e.g. 0.00")) !!}
			</div>
		</div>
		<div class="form-group">
